                      ...
                      children: [
                        ...
                        Column(children: [
                          Container(
                            ...
                            child: Text("Mediterranean Chick Salad", style: AppWidget.semiBooldTextFeildStyle(),)),
                            SizedBox(height: 5.0,),
                            Container(
                            width: MediaQuery.of(context).size.width/2,
                            child: Text("Honney goot cheese", style: AppWidget.LightTextFeildStyle(),)),
                            SizedBox(height: 5.0,),
                            Container(
                            width: MediaQuery.of(context).size.width/2,
                            child: Text("28.000 VND", style: AppWidget.semiBooldTextFeildStyle(),)),
                        ],)
                      ],
                    ),
                  ),
